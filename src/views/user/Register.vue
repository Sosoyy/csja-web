        ...
        <a-form-item>
          <a-input-password
            v-decorator="[
              'password',
              {
                rules: [{ required: true, message: $t('user.password.required') }, { validator: handlePasswordLevel }],
                validateTrigger: ['change', 'blur'],
              },
            ]"
            size="large"
      ...
      <a-form-item>
        <a-input-password
          v-decorator="[
            'password2',
            {
              rules: [{ required: true, message: $t('user.password.required') }, { validator: handlePasswordCheck }],
              validateTrigger: ['change', 'blur'],
            },
          ]"
          size="large"
